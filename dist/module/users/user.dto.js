...
__decorate([
    ...
    (0, class_validator_1.IsString)({ message: '用户名必须是String' }),
    __metadata("design:type", String)
], RegisterInfoDTO.prototype, "username", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: '密码不能为空' }),
    (0, class_validator_1.IsString)({ message: '密码必须是String' }),
    __metadata("design:type", String)
], RegisterInfoDTO.prototype, "password", void 0);
__decorate([
    (0, class_validator_1.IsNumber)({}, { message: '年龄必须是数字' }),
    __metadata("design:type", Number)
], RegisterInfoDTO.prototype, "age", void 0);
